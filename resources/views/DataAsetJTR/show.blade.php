                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                  <input type="text" name="spec_fabrication" class="form-control form-control-sm" id="spec_fabrication" placeholder="spec_fabrication" value="{{ $data_aset_jtr->spec_fabrication }}" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                  <input type="text" name="NumberofPole" class="form-control form-control-sm" id="NumberofPole" placeholder="NumberofPole" value="{{ $data_aset_jtr->NumberofPole }}" readonly>
                                </div>
                            </div>
                            <div class="form-group row">

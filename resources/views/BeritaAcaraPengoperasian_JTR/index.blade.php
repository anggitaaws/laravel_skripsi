                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class = "btn-group" role="group" aria-label="Basic example">
                                            ...
                                            <form action ="{{ route('BeritaAcaraPengoperasianJTR.destroy',$item->id) }}" method="post" type="button" class="btn btn-primary rounded submit px-1" style="background-color: #14A2BA;" onsubmit="return confirm('Delete?')">
                                                @csrf
                                                @method('delete')

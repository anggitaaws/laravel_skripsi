            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-body fw-semi-bold" style="color: #125D72;">
                                Halaman berita acara pengoperasian jtm merupakan sekumpulan berita acara pengoperasian jtm yang dimiliki PT PLN (Persero) UP3 Pinrang
                            </div>
                        </div>
                        <div class="card mb-3">
                    ...
                    <div class="table-responsive">
                        ...
                        <tbody>
                            @if ($berita_acara_pengoperasian_jtm->count() > 0)
                            @foreach ($berita_acara_pengoperasian_jtm as $item)
                                <tr>
                                    ...
                                    <td>
                                        <div class = "btn-group" role="group" aria-label="Basic example">
                                            ...
                                            @if(auth()->user()->role === 'superadmin')
                                            <a href="{{ Route('BeritaAcaraPengoperasianJTM.edit',$item->id) }}" type="button" class="btn btn-primary rounded submit px-1 btn-gap" style="background-color: #14A2BA;">Edit</a>
                                            <form action ="{{ Route('BeritaAcaraPengoperasianJTM.destroy',$item->id) }}" method="post" type="button" class="btn btn-primary rounded submit px-1" style="background-color: #14A2BA;" onsubmit="return confirm('Delete?')">
                                                @csrf
                                                @method('delete')
                                            <button class = "btn btn-primary submit" style="background-color: #14A2BA;">Hapus</button>
                                            </form>
                                            @endif
                                            <a href="{{ Route('BeritaAcaraPengoperasianJTM.unduhexcel',$item->id) }}" type="button" class="btn btn-primary rounded submit px-1 btn-gap" style="background-color: #14A2BA;">Unduh Excel</a>
                                            <a href="{{ Route('BeritaAcaraPengoperasianJTM.unduhpdf',$item->id) }}" type="button" class="btn btn-primary rounded submit px-1 btn-gap" style="background-color: #14A2BA;">Unduh PDF</a>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
                                @else
                                <tr>
                                    <td class="align-middle text-center" colspan="24"> Berita Acara Pengoperasian JTM Kosong </td>
                                    </tr>
                                    @endif
                            </tbody>
                        </table>

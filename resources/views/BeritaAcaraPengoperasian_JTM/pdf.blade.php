...
<table style="width: 100%; text-align: center; margin-top: 40px;">
    <tr>
        <td style="width: 50%;">
            ...
            JTC KONS. DAN LOG<br>
            <br><br><br><br>
            <strong>{{$berita_acara_pengoperasian_jtm->pelaksana}}</strong>
        </td>
        <td style="width: 50%;">
            Pengawas,<br>
            TL. TEKNIK<br>
            <br><br><br><br>
            <strong>{{$berita_acara_pengoperasian_jtm->pengawas}}</strong>
        </td>
    </tr>
</table>
...
<div style="text-align: center; margin-top: 40px;">
    ...
    MANAGER ULP<br>
    <br><br><br><br>
    <strong>{{$berita_acara_pengoperasian_jtm->manager_ulp}}</strong>
</div>
        </body>
</html>
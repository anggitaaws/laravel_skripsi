...
/* Add this to make sure R-r, S-s, T-T columns get a colon */
    ...
    <body>
        ...
        <tr>
            ...
            <table class="info-table-no-border">
                <tr>
                    <td> ULP </td>
                    <td> {{ $berita_acara_pengoperasian_gd->ulp }}</td>
                </tr>
                <tr>
                    <td> NO SPBJ  </td>
                    <td> {{ $berita_acara_pengoperasian_gd->no_spbj }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td> {{ $berita_acara_pengoperasian_gd->latitude }}</td>
                </tr>
                <tr>
                    <td> KOORDINAT LONGITUDE </td>
                    <td> {{ $berita_acara_pengoperasian_gd->longitude }}</td>
                </tr>
                <tr>
                    <td> PENYULANG </td>
                    <td> {{ $berita_acara_pengoperasian_gd->penyulang }}</td>
                </tr>
                <tr>
                    <td> KEYPOINT
                    <td> {{ $berita_acara_pengoperasian_gd->keypoint }}</td>
                </tr>
                <tr>
                    <td> SECTION 
                    <td> {{ $berita_acara_pengoperasian_gd->section }}</td>
                </tr>
                <tr>
                    <td> SEGMENT </td>
                    <td> {{ $berita_acara_pengoperasian_gd->segment }}</td>
                </tr>
                <tr>
                    <td> KONSTRUKSI </td>
                    <td> {{ $berita_acara_pengoperasian_gd->construction }}</td>
                </tr>
                <tr>
                    <td> PHASA </td>
                    <td> {{ $berita_acara_pengoperasian_gd->phase }}</td>
                </tr>
            </table> 
        </div>
        <div class="content">
            <table class="info-table">
                ...
                <tr>
                    ...
                    <td> {{ $berita_acara_pengoperasian_gd->spec_voltage }} V</td>
                </tr>
                <tr>
                    <td>15</td>
                    <td>KENAIKAN SUHU</td>
                ...
                <tr>
                    <td>17</td>
                    <td>BEBAN TRAFO</td>
                    <td> {{ $berita_acara_pengoperasian_gd->trafo_load }} KVA </td>
                </tr>
                <tr>
                    <td>18</td>
                    <td>KETERANGAN</td>
        ...
        <h3 class="title" style="font-weight: normal; text-align: left;">Pemeriksaan Tahanan Isolasi Trafo yang Terpasang </h3>
            <table class="info-table-no-border" style="width: 100%; text-align: center;">
                <tr>
                    <td>R-Body</td>
                    <td class="ohm-symbol">{{ $berita_acara_pengoperasian_gd->insulation_r_body }} GΩ</td>
                    <td>R-r</td>
                    <td class="ohm-symbol">{{ $berita_acara_pengoperasian_gd->insulation_R_r }} GΩ</td>
                </tr>
                <tr>
                    <td>S-Body</td>
                    <td class="ohm-symbol">{{ $berita_acara_pengoperasian_gd->insulation_s_body }} GΩ</td>
                    <td>S-s</td>
                    <td class="ohm-symbol">{{ $berita_acara_pengoperasian_gd->insulation_S_s }} GΩ</td>
                </tr>
                <tr>
                    <td>T-Body</td>
                    <td class="ohm-symbol">{{ $berita_acara_pengoperasian_gd->insulation_t_body }} GΩ</td>
                    <td>T-T</td>
                    <td class="ohm-symbol">{{ $berita_acara_pengoperasian_gd->insulation_T_t }} GΩ</td>
                </tr>
                <tr>
                    <td>Tahanan Pentanahan Netral Trafo Dan Ujung JTR</td>
                    <td class="ohm-symbol">{{ $berita_acara_pengoperasian_gd->earthneutral}} GΩ</td>
                </tr>
                <tr>
                    <td>Tahanan Pentanahan Lightning Arrester</td>
                    <td class="ohm-symbol">{{ $berita_acara_pengoperasian_gd->earthla}} GΩ</td>
                </tr>
                <tr>
                    <td>Tahanan Pentanahan Body Trafo</td>
                    <td class="ohm-symbol">{{ $berita_acara_pengoperasian_gd->earthbody }} GΩ</td>
                </tr>
            </table>
...
<table style="width: 100%; text-align: center; margin-top: 40px;">
    <tr>
        <td style="width: 50%;">
            ...
            JTC KONS. DAN LOG<br>
            <br><br><br><br>
            <strong>{{$berita_acara_pengoperasian_gd->pelaksana}}</strong>
        </td>
        <td style="width: 50%;">
            Pengawas,<br>
            TL. TEKNIK<br>
            <br><br><br><br>
            <strong>{{$berita_acara_pengoperasian_gd->pengawas}}</strong>
        </td>
    </tr>
</table>
...
<div style="text-align: center; margin-top: 40px;">
    ...
    MANAGER ULP<br>
    <br><br><br><br>
    <strong>{{$berita_acara_pengoperasian_gd->manager_ulp}}</strong>
</div>
        </body>
</html>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                              <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                  <input type="text" name="id_gardu" class="form-control form-control-sm" id="id_gardu" placeholder="id_gardu" value="{{ $berita_acara_pengoperasian_gd->id_gardu }}">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                  <input type="date" name="tanggal" class="form-control form-control-sm" id="tanggal" placeholder="tanggal" value="{{ $berita_acara_pengoperasian_gd->tanggal }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                  <input type="text" name="phase" class="form-control form-control-sm" id="phase" placeholder="phase" value="{{ $berita_acara_pengoperasian_gd->phase }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="colFormLabelSm" class="col-sm-4 col-form-label col-form-label-sm">Merk/Type</label>
                                <div class="col-sm-10">
                                  <input type="text" name="spec_fabrication" class="form-control form-control-sm" id="spec_fabrication" placeholder="spec_fabrication" value="{{ $berita_acara_pengoperasian_gd->spec_fabrication }}">
                                </div>
                            </div>
                            <div class="form-group row">

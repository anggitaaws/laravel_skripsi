                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                              <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                  <input type="text" name="id_gardu" class="form-control form-control-sm" id="id_gardu" placeholder="id_gardu" value="{{ $berita_acara_pengoperasian_gd->id_gardu }}" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                  <input type="text" name="spec_fabrication" class="form-control form-control-sm" id="spec_fabrication" placeholder="spec_fabrication" value="{{ $berita_acara_pengoperasian_gd->spec_fabrication }}" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                  <input type="text" name="trafo_load" class="form-control form-control-sm" id="trafo_load" placeholder="trafo_load" value="{{ $berita_acara_pengoperasian_gd->trafo_load }}" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" name="pelaksana" class="form-control form-control-sm" id="pelaksana" placeholder="pelaksana" value="{{ $berita_acara_pengoperasian_gd->pelaksana }}" readonly>
                            </div>
                        </div>
                          <div class="form-group row">
                            <label for="colFormLabelSm" class="col-sm-4 col-form-label col-form-label-sm">Pengawas</label>
                            <div class="col-sm-10">
                              <input type="text" name="pengawas" class="form-control form-control-sm" id="pengawas" placeholder="pengawas" value="{{ $berita_acara_pengoperasian_gd->pengawas }}" readonly>
                            </div>
                        </div>
                          <div class="form-group row">
                            <label for="colFormLabelSm" class="col-sm-4 col-form-label col-form-label-sm">Manager ULP</label>
                            <div class="col-sm-10">
                              <input type="text" name="manager_ulp" class="form-control form-control-sm" id="manager_ulp" placeholder="manager_ulp" value="{{ $berita_acara_pengoperasian_gd->manager_ulp }}" readonly>
                            </div>
                        </div>
                          <div class="form-group row">

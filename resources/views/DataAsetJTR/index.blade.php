                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-3">
                            <div class="card-header d-flex  align-items-center justify-content-between fw-bold">
                                Tabel Data Aset JTR
                                <a href="{{ route('DataAsetJTR.create') }}" class="btn btn-group btn-primary rounded submit px-1 float-end" margin="right" style="background-color:#14A2BA; color:#fff;">Tambah Data</a>
                            </div>
                            ...
                            @endif
                            <form action="{{ route('DataAsetJTR.search') }}" method="get">
                            <div class="input-group mt-3 mb-4">
                                <input type="text" name="query" class="form-control" placeholder="Cari Data Aset JTR..." value="{{ request()->input('query') }}">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <div class = "btn-group" role="group" aria-label="Basic example">
                                                    ...
                                                    <a href="{{ route('DataAsetJTR.edit',$rs->id) }}" type="button" class="btn btn-primary rounded submit px-1 btn-gap" style="background-color: #14A2BA;">Edit</a>
                                                    <form action ="{{ route('DataAsetJTR.destroy',$rs->id) }}" method="post" type="button" class="btn btn-primary px-1" style="background-color: #14A2BA;" onsubmit="return confirm('Delete?')">
                                                        @csrf
                                                        @method('delete')
                                            ...
                                            @else
                                            <tr>
                                         <td class="align-middle text-center" colspan="24"> Data Aset JTR Kosong </td>
                                            </tr>
                                            @endif
                                    </tbody>
                                </table>

...
.info-table th:first-child, .info-table td:first-child {
    ...
    <body>
        <table class="header">
            ...
            @endif
            <p class="hari-ini-text">Pada Hari ini {{ $berita_acara_update_gd->tanggal }}, Kami yang bertanda tangan di bawah ini telah melaksanakan pengoperasian baru trafo Distribusi dengan data-data sebagai berikut: </p>
